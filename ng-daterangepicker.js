...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    root.daterangepicker = factory(root, {}, root.moment, (root.jQuery || root.Zepto || root.ender || root.$ || angular.element));
  }
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container = $(DRPTemplate);
        $(document.querySelector('body')).append($(DRPTemplate));
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (this.singleDatePicker) {
                ...
                // console.log(this.container[0].querySelector('.ranges'));
                $(this.container[0].querySelector('.ranges')).css('display','block');
            }
        ...
        move: function () {
            ...
            var parentRightEdge = $(window)[0].innerWidth;
    ...
    $.prototype.daterangepicker = function (options, cb) {
